...
def add_analyse():
    ...
    if ref_analyse == "":
        ...
        my_cursor.execute(
            "INSERT INTO analyses (ref_analyse, type_analyse, date_prelevement, date_reception, renseignements_cliniques, macroscopie, pec, validation, sorti, prix, total_encaissement, remise, reste)  VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            (ref_analyse, type_analyse, date_prelevement, date_reception, renseignements_cliniques, macroscopie, pec,
             validation, sorti, prix, total_encaissement, remise, reste))
        mydb.commit()
